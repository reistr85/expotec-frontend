<template>
    <section id="certificados-section">
          <div class="container">
          <div class="row text-center">
            ...
            <div class="row">
                <div class="col-md-6" id="coluna-texto-certificado">
                    <p>
                    ...
                    <button type="button" class="btn btn-primary"><router-link to="/certificados" class="text-white">Acesse aqui</router-link></button>
                </div>
                <div class="col-md-6">
